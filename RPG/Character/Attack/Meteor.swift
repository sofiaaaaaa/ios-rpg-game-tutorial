...
extension Character {
    func Attack_Meteor() {
        let Position = [CGPoint(x: 0, y: 200), CGPoint(x: 150, y: 100),CGPoint(x: -150, y: 100), CGPoint(x: 100, y: 0), CGPoint(x: 200, y: 0),CGPoint(x: 0, y: -200), CGPoint(x: 150, y: 100),CGPoint(x: -150, y: -100), CGPoint(x: -100, y: 0), CGPoint(x: -200, y: 0)]
